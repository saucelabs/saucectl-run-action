...
requestMock.mockImplementation((target) => new Promise((resolve, reject) => {
    if (target === "GET /repos/:org/:repo/releases") {
        resolve({
            status: 200,
            headers: { location: 'mock-url' },
            data: JSON.parse(fs.readFileSync("./tests/fixtures/github-releases-mock.json")),
        });
    }
...
it("Version matching", async () => {
    ...
    const testCases = [["latest", "v0.25.1"], ["0.25.1", "v0.25.1"], ["0.25.0", "v0.25.0"], ["^0.25.0", "v0.25.1"], [">=0.24.0", "v0.25.1"], ["0.24.x", "v0.24.1"], ["v0.26.0-alpha1", "v0.26.0-alpha1"]];
